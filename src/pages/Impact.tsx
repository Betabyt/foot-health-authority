...
import { Shield, TrendingDown, Clock, Banknote, MapPin, BarChart3, Star, CheckCircle } from "lucide-react";
...
const economics = [
  { label: "Cost per nurse trained", value: "~R2,500", note: "Including all materials" },
  { label: "Cost per screening", value: "~R45", note: "Nurse time + consumables" },
  { label: "Cost per amputation (avoided)", value: "~R86,000", note: "EDU-FOOT prevention cost" },
  { label: "Cost per amputation (treated)", value: "~R500,000", note: "Acute + surgery + rehab" },
  { label: "Social Return on Investment", value: "~10:1", note: "Conservative Year 1 estimate" },
...
const Impact = () => (
  <div>
    ...
    <section className="section-padding bg-[linear-gradient(180deg,#E8F4FD_0%,#FFFFFF_100%)]">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
          <div>
            <SectionHeading badge="Proof of Concept" title="What the pilot demonstrated" centered={false} />
          ...
          >
            ...
            <div className="flex flex-wrap items-end gap-4 mb-6">
              ...
              <div className="text-center">
                <div className="font-display text-5xl font-bold text-[#4CAF50]">8</div>
                <div className="text-xs text-white/70 mt-1">After EDU-FOOT</div>
              </div>
              <div className="text-white/40 mb-2">/ 10</div>
            </div>
            <p className="text-xs text-white/70 leading-relaxed">
              Self-reported confidence in performing the full ASK–LOOK–FEEL–TEST–ACT protocol independently,
              measured 1 month post-training.
            </p>
          </motion.div>
        </div>
      </div>
    ...
    <section className="section-padding bg-background">
      <div className="container mx-auto">
        <SectionHeading badge="Unit Economics" title="Prevention is dramatically cheaper than late care" description="Every rand invested in frontline nurse training generates approximately ten rands in avoided healthcare costs." />
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
          {economics.map((item, i) => (
            ...
            >
              <div className="font-display text-2xl font-bold text-[#0072BC] mb-1">{item.value}</div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Cost and SROI figures are programme estimates for planning purposes; to be validated with partner costing data during rollout.
        </p>
      </div>
    </section>
